...
const Login = ({ onLogin, onSignupClick }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const loginUrl = `${config.AUTH_API_BASE_URL || ''}/api/auth/login`;
      ...
      <div className="login-card glass-panel">
        ...
        <div className="oauth-section">
          ...
          <div className="oauth-buttons">
            <a href={`${config.AUTH_API_BASE_URL || 'http://localhost:8081'}/oauth2/authorization/google`} className="oauth-btn google-btn" title="Sign in with Google">
            ...
            <a href={`${config.AUTH_API_BASE_URL || 'http://localhost:8081'}/oauth2/authorization/facebook`} className="oauth-btn facebook-btn" title="Sign in with Facebook">
              <svg viewBox="0 0 24 24" width="20" height="20" fill="#1877F2">
                <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
              </svg>
            </a>
            <a href={`${config.AUTH_API_BASE_URL || 'http://localhost:8081'}/oauth2/authorization/github`} className="oauth-btn github-btn" title="Sign in with GitHub">
              <svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor">
