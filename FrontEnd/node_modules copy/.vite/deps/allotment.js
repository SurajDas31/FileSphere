...
//#region node_modules/allotment/dist/modern.mjs
...
*/
var d, f, p, S = u((c || (c = 1, d = m, function() {
...
var z, w, y = u((p || (p = 1, f = function e(t, i) {
	if (t === i) return !0;
...
var b, I, x = u(function() {
	if (w) return z;
	w = 1;
	var e = /^\s+|\s+$/g, t = /^[-+]0x[0-9a-f]+$/i, i = /^0b[01]+$/i, s = /^0o[0-7]+$/i, n = parseInt, r = Object.prototype.toString;
	function o(e) {
		var t = typeof e;
...
var _ = u(function() {
	if (I) return b;
	I = 1;
	var e = /^\s+|\s+$/g, t = /^[-+]0x[0-9a-f]+$/i, i = /^0b[01]+$/i, s = /^0o[0-7]+$/i, n = parseInt, r = "object" == typeof l && l && l.Object === Object && l, o = "object" == typeof self && self && self.Object === Object && self, a = r || o || Function("return this")(), h = Object.prototype.toString, u = Math.max, c = Math.min, m = function m() {
		return a.Date.now();
	};
	function d(e) {
		var t = typeof e;
	...
	return b = function(e, t, i) {
		var s, n, r, o, a, h, l = 0, p = !1, v = !1, S = !0;
...
function E(e) {
	const { ref: r, box: o = "content-box" } = e, [{ width: a, height: h }, l] = (0, import_react.useState)(V), u = function() {
		const e = (0, import_react.useRef)(!1);
		return (0, import_react.useEffect)(() => (e.current = !0, () => {
			e.current = !1;
		}), []), (0, import_react.useCallback)(() => e.current, []);
	}(), c = (0, import_react.useRef)(_extends({}, V)), m = (0, import_react.useRef)(void 0);
	return m.current = e.onResize, (0, import_react.useEffect)(() => {
		if (!r.current) return;
		if ("undefined" == typeof window || !("ResizeObserver" in window)) return;
		const e = new ResizeObserver(([e]) => {
			const t = "border-box" === o ? "borderBoxSize" : "device-pixel-content-box" === o ? "devicePixelContentBoxSize" : "contentBoxSize", i = N(e, t, "inlineSize"), s = N(e, t, "blockSize");
		...
		return e.observe(r.current, { box: o }), () => {
			e.disconnect();
		};
	}, [
		o,
...
var H = j, Y = F, k = "undefined" != typeof window && void 0 !== window.document && void 0 !== window.document.createElement ? import_react.useLayoutEffect : import_react.useEffect;
var $ = class {
	constructor() {
		this._size = void 0;
	}
...
function B(e, t) {
	const i = e.length, s = i - t.length;
	return s >= 0 && e.slice(s, i) === t;
}
var R, W = { exports: {} };
var G = u((R || (R = 1, function(e) {
	...
	Object.create && (s.prototype = Object.create(null), new s().__proto__ || (i = !1)), a.prototype.eventNames = function() {
		...
		if (u.fn) {
			switch (u.once && this.removeListener(e, u.fn, void 0, !0), c) {
				...
				case 3: return u.fn.call(u.context, t, s), !0;
				case 4: return u.fn.call(u.context, t, s, n), !0;
				case 5: return u.fn.call(u.context, t, s, n, r), !0;
				case 6: return u.fn.call(u.context, t, s, n, r, o), !0;
			}
		...
		if (a.fn) a.fn !== t || n && !a.once || s && a.context !== s || o(this, r);
		else {
...
function K(e, t, i = 1) {
	const s = Math.max(0, Math.ceil((t - e) / i)), n = new Array(s);
	let r = -1;
	for (; ++r < s;) n[r] = e + r * i;
	return n;
}
...
var ce;
var me;
(me = ce || (ce = {})).Distribute = { type: "distribute" }, me.Split = function(e) {
	return {
		type: "split",
		index: e
	};
...
var Se = class extends G {
	...
	constructor(e, t = {}, i, s, n) {
		...
		if (super(), this.onDidChange = void 0, this.onDidDragStart = void 0, this.onDidDragEnd = void 0, this.orientation = void 0, this.sashContainer = void 0, this.size = 0, this.contentSize = 0, this.proportions = void 0, this.viewItems = [], this.sashItems = [], this.sashDragState = void 0, this.proportionalLayout = void 0, this.getSashOrthogonalSize = void 0, this._startSnappingEnabled = !0, this._endSnappingEnabled = !0, this.onSashEnd = (e) => {
			...
			for (const _e3 of this.viewItems) _e3.enabled = !0;
	...
	addView(e, t, i, s = this.viewItems.length, n) {
		let r;
		r = "number" == typeof i ? i : "split" === i.type ? this.getViewSize(i.index) / 2 : "invisible" === i.type ? { cachedVisibleSize: i.cachedVisibleSize } : t.minimumSize;
		...
		if (this.viewItems.splice(s, 0, o), this.viewItems.length > 1) {
			...
			}, { orientation: oe.Horizontal }) : new ue(this.sashContainer, {
				getVerticalSashLeft: (e) => this.getSashPosition(e),
				getVerticalSashHeight: this.getSashOrthogonalSize
			}, { orientation: oe.Vertical }), _t2 = this.orientation === oe.Vertical ? (t) => ({
				sash: _e5,
				start: t.startY,
				current: t.currentY
			}) : (t) => ({
			...
			_e5.on("start", (e) => {
				...
				const t = this.sashItems.findIndex((t) => t.sash === _e5), i = K(t, -1, -1), s = K(t + 1, this.viewItems.length), n = this.findFirstSnapIndex(i), r = this.findFirstSnapIndex(s);
	...
	moveView(e, t, i) {
		const s = this.getViewCachedVisibleSize(t), n = void 0 === s ? this.getViewSize(t) : ce.Invisible(s), r = this.removeView(t);
	...
	layout(e = this.size) {
		...
		if (this.size = e, this.proportions) for (let _t4 = 0; _t4 < this.viewItems.length; _t4++) {
			...
			const i = K(0, this.viewItems.length), s = i.filter((e) => this.viewItems[e].priority === de.Low), n = i.filter((e) => this.viewItems[e].priority === de.High);
	...
	resizeView(e, t) {
		...
		const i = K(0, this.viewItems.length).filter((t) => t !== e), s = [...i.filter((e) => this.viewItems[e].priority === de.Low), e], n = i.filter((e) => this.viewItems[e].priority === de.High), r = this.viewItems[e];
	...
	distributeViewSizes() {
		...
		const s = K(0, this.viewItems.length), n = s.filter((e) => this.viewItems[e].priority === de.Low), r = s.filter((e) => this.viewItems[e].priority === de.High);
		this.relayout(n, r);
	}
	dispose() {
	...
	onSashStart({ sash: e, start: t }) {
		...
		((e) => {
			...
			if ("number" == typeof f) {
				const _e7 = this.viewItems[f], _t7 = Math.floor(_e7.viewMinimumSize / 2);
				n = {
					index: f,
	...
	onSashChange({ current: e }) {
		const { index: t, start: i, sizes: s, minDelta: n, maxDelta: r, snapBefore: o, snapAfter: a } = this.sashDragState;
	...
	resize(e, t, i = this.viewItems.map((e) => e.size), s, n, r = Number.NEGATIVE_INFINITY, o = Number.POSITIVE_INFINITY, a, h) {
		...
		const l = K(e, -1, -1), u = K(e + 1, this.viewItems.length);
		if (n) for (const _e8 of n) J(l, _e8), J(u, _e8);
		if (s) for (const _e9 of s) U(l, _e9), U(u, _e9);
		const c = l.map((e) => this.viewItems[e]), m = l.map((e) => i[e]), d = u.map((e) => this.viewItems[e]), f = u.map((e) => i[e]), p = l.reduce((e, t) => e + (this.viewItems[t].minimumSize - i[t]), 0), v = l.reduce((e, t) => e + (this.viewItems[t].maximumSize - i[t]), 0), S = 0 === u.length ? Number.POSITIVE_INFINITY : u.reduce((e, t) => e + (i[t] - this.viewItems[t].minimumSize), 0), z = 0 === u.length ? Number.NEGATIVE_INFINITY : u.reduce((e, t) => e + (i[t] - this.viewItems[t].maximumSize), 0), w = Math.max(p, z, r), g = Math.min(S, v, o);
		let y = !1;
		if (a) {
			const _e0 = this.viewItems[a.index], _i4 = t >= a.limitDelta;
			y = _i4 !== _e0.visible, _e0.setVisible(_i4, a.size);
		}
		if (!y && h) {
			const _e1 = this.viewItems[h.index], _i5 = t < h.limitDelta;
		...
		for (let _e10 = 0, _i6 = t = x(t, w, g); _e10 < c.length; _e10++) {
			const _t8 = c[_e10], _s2 = x(m[_e10] + _i6, _t8.minimumSize, _t8.maximumSize);
			_i6 -= _s2 - m[_e10], _t8.size = _s2;
		}
		for (let _e11 = 0, _i7 = t; _e11 < d.length; _e11++) {
			const _t9 = d[_e11], _s3 = x(f[_e11] - _i7, _t9.minimumSize, _t9.maximumSize);
	...
	distributeEmptySpace(e) {
		...
		let i = this.size - t;
		const s = K(0, this.viewItems.length), n = [], r = s.filter((e) => this.viewItems[e].priority === de.Low), o = s.filter((e) => this.viewItems[e].priority === de.Normal), a = s.filter((e) => this.viewItems[e].priority === de.High);
		n.push(...a, ...o, ...r), "number" == typeof e && U(n, e);
		for (let _e12 = 0; 0 !== i && _e12 < n.length; _e12++) {
			const _t0 = this.viewItems[n[_e12]], _s4 = x(_t0.size + i, _t0.minimumSize, _t0.maximumSize);
	...
	updateSashEnablement() {
		...
		e = !1;
		const i = this.viewItems.map((t) => e = t.maximumSize - t.size > 0 || e), s = [...this.viewItems].reverse();
		e = !1;
		...
		for (let _e13 = 0; _e13 < this.sashItems.length; _e13++) {
			const { sash: _s5 } = this.sashItems[_e13];
			o += this.viewItems[_e13].size;
			const a = !(t[_e13] && r[_e13 + 1]), h = !(i[_e13] && n[_e13 + 1]);
			if (a && h) {
				const _i8 = K(_e13, -1, -1), _r = K(_e13 + 1, this.viewItems.length), _a = this.findFirstSnapIndex(_i8), _h = this.findFirstSnapIndex(_r), l = "number" == typeof _a && !this.viewItems[_a].visible, u = "number" == typeof _h && !this.viewItems[_h].visible;
...
var ye = class {
	...
	set preferredSize(e) {
		if ("number" == typeof e) this.layoutStrategy = new ze(e);
...
var Ie = (0, import_react.forwardRef)(({ className: t, children: i }, s) => import_react.createElement("div", {
	ref: s,
	className: S("split-view-view", M, t)
}, i));
Ie.displayName = "Allotment.Pane";
var xe = (0, import_react.forwardRef)(({ children: r, className: o, id: l, maxSize: u = Infinity, minSize: c = 30, proportionalLayout: m = !0, separator: d = !0, sizes: f, defaultSizes: p = f, snap: v = !1, vertical: z = !1, onChange: w, onReset: g, onVisibleChange: b, onDragStart: I, onDragEnd: x }, _) => {
	const V = (0, import_react.useRef)(null), N = (0, import_react.useRef)([]), D = (0, import_react.useRef)(/* @__PURE__ */ new Map()), M = (0, import_react.useRef)(null), A = (0, import_react.useRef)(/* @__PURE__ */ new Map()), j = (0, import_react.useRef)(new $()), F = (0, import_react.useRef)([]), [Y, B] = (0, import_react.useState)(!1);
	f && console.warn("Prop sizes is deprecated. Please use defaultSizes instead.");
	const R = (0, import_react.useMemo)(() => import_react.Children.toArray(r).filter(import_react.isValidElement), [r]), W = (0, import_react.useCallback)((e) => {
	...
	return (0, import_react.useImperativeHandle)(_, () => ({
		reset: () => {
			if (g) g();
			else {
				var _M$current2;
		...
		const t = _extends({
			...
			views: p.map((e, t) => {
				...
				const i = D.current.get(N.current[t]), s = new ye(j.current, _extends({
				...
				}, (i == null ? void 0 : i.preferredSize) && { preferredSize: i == null ? void 0 : i.preferredSize }, { snap: (_i$snap = i == null ? void 0 : i.snap) != null ? _i$snap : v }));
		...
		if (Y) {
			const e = R.map((e) => e.key), t = [...N.current], i = e.filter((e) => !N.current.includes(e)), s = e.filter((e) => N.current.includes(e)), n = N.current.map((t) => !e.includes(t));
			...
			for (const _s6 of i) {
				...
				const _i9 = D.current.get(_s6), _n2 = new ye(j.current, _extends({
					element: document.createElement("div"),
				...
				}, (_i9 == null ? void 0 : _i9.preferredSize) && { preferredSize: _i9 == null ? void 0 : _i9.preferredSize }, { snap: (_i9$snap = _i9 == null ? void 0 : _i9.snap) != null ? _i9$snap : v }));
			...
			for (const _t12 of i) {
				var _M$current8;
				const _i1 = e.findIndex((e) => e === _t12), _s8 = F.current[_i1].preferredSize;
				void 0 !== _s8 && ((_M$current8 = M.current) == null || _M$current8.resizeView(_i1, _s8));
			}
			for (const _t13 of [...i, ...s]) {
				var _M$current9, _M$current0;
				const _i10 = D.current.get(_t13), _s9 = e.findIndex((e) => e === _t13);
				_i10 && be(_i10) && void 0 !== _i10.visible && ((_M$current9 = M.current) == null ? void 0 : _M$current9.isViewVisible(_s9)) !== _i10.visible && ((_M$current0 = M.current) == null || _M$current0.setViewVisible(_s9, _i10.visible));
			}
			for (const _t14 of s) {
				const _i11 = D.current.get(_t14), _s0 = e.findIndex((e) => e === _t14);
				if (_i11 && be(_i11)) {
					var _M$current1;
					void 0 !== _i11.preferredSize && F.current[_s0].preferredSize !== _i11.preferredSize && (F.current[_s0].preferredSize = _i11.preferredSize);
					let _e23 = !1;
					void 0 !== _i11.minSize && F.current[_s0].minimumSize !== _i11.minSize && (F.current[_s0].minimumSize = _i11.minSize, _e23 = !0), void 0 !== _i11.maxSize && F.current[_s0].maximumSize !== _i11.maxSize && (F.current[_s0].maximumSize = _i11.maxSize, _e23 = !0), _e23 && ((_M$current1 = M.current) == null || _M$current1.layout());
				}
			}
		...
		ref: V,
		className: S("split-view", z ? "split-view-vertical" : "split-view-horizontal", { "split-view-separator-border": d }, L, z ? P : T, { [C]: d }, o),
		id: l
	}, import_react.createElement("div", { className: S("split-view-container", O) }, import_react.Children.toArray(r).map((t) => {
		if (!import_react.isValidElement(t)) return null;
		const i = t.key;
		return "Allotment.Pane" === t.type.displayName ? (D.current.set(i, t.props), import_react.cloneElement(t, {
			key: i,
			ref: (e) => {
				const s = t.ref;
				s && (s.current = e), e ? A.current.set(i, e) : A.current.delete(i);
			}
		})) : import_react.createElement(Ie, {
			key: i,
			ref: (e) => {
...
var Ve = Object.assign(xe, { Pane: Ie });
//#endregion
