...
INSERT INTO tenants (id, name, tenant_key, max_file_size_bytes) VALUES ('04ac0ad3-4465-48bc-bc28-483ef2bf5443', 'Root Tenant', 1000, 52428800) ON CONFLICT (id) DO NOTHING;
